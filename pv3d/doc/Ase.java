...
public class Ase extends Mesh3D {
	 ...
	 */
	public Ase(MaterialObject3D material, String filename, 
		double scale, Map<String, Object> initObject) {
		super(material, new ArrayList<Vertex3D>(), 
			new ArrayList<Face3D>(), null, initObject);
