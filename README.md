...
(1) How to calculate the matrix to transform 3 points (u1,v1),(u2,v2),(u3,v3) to 3 points (x1,y1),(x2,y2),(x3,y3).    
(2) How to make the matrix transform on the image triangle region, and get the target image triangle region.   
